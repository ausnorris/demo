...
export war_file=https://vra7cafe.virtualiseme.com.au/artifactory/nanotrader/spring-nanotrader-services-1.0.1.BUILD-SNAPSHOT.war
wget --no-check-certificate $war_file
mv spring-nanotrader-services-1.0.1.BUILD-SNAPSHOT.war /tmp
export war_file=/tmp/spring-nanotrader-services-1.0.1.BUILD-SNAPSHOT.war
